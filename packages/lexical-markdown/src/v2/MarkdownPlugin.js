...
export function registerMarkdownPlugin(
  ...
  const transform = (
    ...
    runTextTransformers(anchorNode, anchorOffset, textTransformersIndex);
  };

  return editor.registerUpdateListener(
    ({tags, dirtyLeaves, editorState, prevEditorState}) => {
      // Ignore updates from undo/redo and from auto-format itself (as changes already calculated)
